...
npm run start:dev:server - запуск сервера в dev режиме
npm run start:dev:client - запуск frontend проекта в dev режиме
```
...
-   `npm run start` - Запуск frontend проекта на webpack dev server + backend
-   `npm run start:dev:client` - Запуск frontend проекта на webpack dev server
...
-   `npm run prettier` - Форматирование файлов в проекте
